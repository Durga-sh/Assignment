...
export const MOCK_TRANSACTIONS: Transaction[] = [
  ...
  { id: 'TXN-120', date: '2026-04-08', amount: 290, category: 'Food', type: 'expense', note: 'Groceries and household items' },
  { id: 'TXN-121', date: '2026-04-12', amount: 5200, category: 'Freelance', type: 'income', note: 'Dashboard implementation' },
  { id: 'TXN-122', date: '2026-04-16', amount: 410, category: 'Utilities', type: 'expense', note: 'Electricity and internet bill' },
  { id: 'TXN-123', date: '2026-04-21', amount: 220, category: 'Transport', type: 'expense', note: 'Fuel refill and parking' },
  { id: 'TXN-124', date: '2026-04-25', amount: 3400, category: 'Investments', type: 'income', note: 'ETF partial redemption' },
]
